...
/// @nodoc
@JsonSerializable()
final class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl({this.error});
...
abstract final class _ErrorModel implements ErrorModel {
  const factory _ErrorModel({final String? error}) = _$ErrorModelImpl;
